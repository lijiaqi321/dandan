...
<script type="text/javascript" src="/statics/js/shopping.js"></script>
</head>
...
<!--中间部分开始-->
<div id="main">
  <div>&nbsp;&nbsp;<img src="/statics/images/shopping_myshopping.gif" alt="shopping"> <a href="#">全场免运费活动中</a></div>
  <!--为您推荐商品开始-->
  <div class="shopping_commend">
     <div class="shopping_commend_left">根据您挑选的商品，当当为您推荐</div>
     <div class="shopping_commend_right"><img src="/statics/images/shopping_arrow_up.gif" alt="shopping" id="shopping_commend_arrow" onClick="shopping_commend_show()"></div>
  </div>
...
<div class="shopping_list_top">您已选购以下商品</div>
  ...
  <tr class="shopping_product_list" id="shoppingProduct_06" onMouseOver="productOver('shoppingProduct_06')"  onMouseOut="productOut('shoppingProduct_06')">
     ...
     <div class="shopping_list_end">
      <ul>
       <li class="shopping_list_end_1"><input name="" type="image" src="/statics/images/shopping_balance.gif"></li>
