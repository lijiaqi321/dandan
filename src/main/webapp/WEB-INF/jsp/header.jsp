...
<link href="/statics/css/template.css" rel="stylesheet" type="text/css" />
<script src="/statics/js/menu_tree.js" type="text/javascript"></script>
</head>

<body>
<!--顶部开始-->
<div class="header_top">
   <div class="header_top_left">您好！欢迎光临当当网 [<a href="/user/login.html" target="_parent">登录</a> | <a href="/user/register.html" target="_parent">免费注册</a>]</div>
   <div class="header_top_right">
   <ul>
      <li><a href="#" target="_self">帮助</a></li>
      <li>|</li>
      <li onmouseover="myddang_show('dd_menu_top_down')" onmouseout="myddang_hidden('dd_menu_top_down')"><a href="#" target="_self">我的当当</a> <img src="/statics/images/dd_arrow_down.gif" alt="arrow" />
      ...
      <li>|</li>
      <li><a href="/user/shopping.html" target="_parent">购物车</a></li>
      <li><img src="/statics/images/dd_header_shop.gif" alt="shopping"/></li>
   </ul>
   </div>
</div>
<!--导航开始-->
<div class="header_middle">
<div class="logo"><img src="/statics/images/dd_logo.gif" alt="logo"/></div>
<div class="menu_left">
  <dl>
   <dd class="menu_left_first"></dd>
   </dl>
   <ul id="menu_left_bold">
   <li><a href="/user/dologin.html" target="_parent" class="bold">首页</a></li>
   <li>|</li>
   <li><a href="/user/product.html" target="_parent" class="bold">图书</a></li>
   <li>|</li>
...
<div class="menu_right" id="menu_dull_red">
 <ul>
   ...
   <li class="menu_right_3"><a href="#" target="_self">当当<img src="/statics/images/dd_header_top.png" alt="榜" /></a>
   </li>
...
<div class="header_search">
 ...
 <ul id="header_serach_mid_menu">
   ...
   <li><input type="image" class="header_secrch_btn" src="/statics/images/dd_header_search_btn.jpg" /></li>
   <li><img src="/statics/images/dd_arrow_right.gif" alt="arrow"/> <a href="#" target="_self">高级搜索</a></li>
   <li>|</li>
   <li><img src="/statics/images/dd_header_search_top.jpg" alt="搜索风云榜"/></li>
