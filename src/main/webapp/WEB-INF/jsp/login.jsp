...
<body>
<div id="header">
   <div class="login_header_left"><img src="/statics/images/logo.gif" alt="logo"></div>
   <div class="login_header_mid"><img src="/statics/images/login_header.gif" alt="header"></div>
   <div class="login_header_right"><a href="/user/dologin.html" class="blue">首页</a> | <a href="product.jsp" class="blue">商品展示页</a>  | <a href="shopping.jsp" class="blue">购物车</a> | <a href="register.jsp" class="blue">注册</a></div>
</div>

<div id="main">
  <div class="login_main_left">
     <div><img src="/statics/images/login_main_01.jpg" alt="中间图片">
          <img src="/statics/images/login_main_02.jpg" alt="中间图片">
          <img src="/statics/images/login_main_03.jpg" alt="中间图片">
    </div>
  ...
  <div class="login_main_mid">
    ...
    <form action="/user/dologin.html" method="post" onSubmit="return checkLogin()">
  ...
  <div class="login_main_right"><img src="/statics/images/login_main_04.jpg" alt="右侧图片"></div>
</div>
