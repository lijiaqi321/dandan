...
<div id="right" class="right">
    ...
    <img src="/statics/images/dd_scroll.jpg" id="right1" /> </div>
<div id="header">
    <iframe src="/user/header.html" height="155px" width="960px" frameborder="0"></iframe>
</div>
<!--网站中间内容开始-->
<div id="main">
    <div class="dd_index_top_adver"><img src="/statics/images/dd_index_top_adver.jpg" alt="通栏广告图片" /></div>
    <!--左侧菜单开始-->
    <div id="catList">
        <!--推荐分类-->
        <div class="book_sort">
        ...
        <!--图书商品分类开始-->
        <div class="book_sort">
            <div class="book_sort_bg"><img src="/statics/images/dd_book_cate_icon.gif" alt="图书" /> 图书商品分类</div>
    ...
    <div id="content">
        ...
        <div class="scroll_mid"> <img src="/statics/images/dd_scroll_2.jpg" alt="轮换显示的图片广告" id="dd_scroll"/>
        ...
        <div class="book_sort">
            ...
            <div class="book_class" style="height:250px;">
                <!--历史-->
                <dl id="book_history">
                    <dt><img src="/statics/images/dd_history_1.jpg" alt="history"/></dt>
                    <dd><font class="book_title">《中国时代》（上）</font><br />
                        ...
                        定价：￥39.00<br />
                        当当价：￥27.00 </dd>
                    <dt><img src="/statics/images/dd_history_2.jpg" alt="history"/></dt>
                    <dd><font class="book_title">中国历史的屈辱</font><br />
                        ...
                        定价：￥26.00<br />
                        当当价：￥18.20 </dd>
                    <dt><img src="/statics/images/dd_history_3.jpg" alt="history"/></dt>
                    <dd><font class="book_title">《中国时代》（下）</font><br />
                        ...
                        定价：￥38.00<br />
                        当当价：￥26.30 </dd>
                    <dt><img src="/statics/images/dd_history_4.jpg" alt="history"/></dt>
                ...
                <dl id="book_family" class="book_none">
                    <dt><img src="/statics/images/dd_family_1.jpg" alt="history"/></dt>
                    <dd><font class="book_title">嘿，我知道你</font><br />
                        ...
                        定价：￥28.80<br />
                        当当价：￥17.90 </dd>
                    <dt><img src="/statics/images/dd_family_2.jpg" alt="history"/></dt>
                    <dd><font class="book_title">择业要趁早</font><br />
                        ...
                        定价：￥28.00<br />
                        当当价：￥19.30 </dd>
                    <dt><img src="/statics/images/dd_family_3.jpg" alt="history"/></dt>
                    <dd><font class="book_title">爷爷奶奶的“孙子兵法”</font><br />
                        ...
                        定价：￥28.00<br />
                        当当价：￥17.40 </dd>
                    <dt><img src="/statics/images/dd_family_4.jpg" alt="history"/></dt>
                ...
                <dl id="book_culture" class="book_none">
                    <dt><img src="/statics/images/dd_culture_1.jpg" alt="history"/></dt>
                    <dd><font class="book_title">嘿，我知道你</font><br />
                        作者：兰海　著 <br />
                        出版社：中国妇女出版社 <br />
                        <font class="book_publish">出版时间：2009年10月</font><br />
                        定价：￥28.80<br />
                        当当价：￥17.90 </dd>
                    <dt><img src="/statics/images/dd_culture_2.jpg" alt="history"/></dt>
                    <dd><font class="book_title">择业要趁早</font><br />
                        作者：（美）列文 <br />
                        出版社：海天出版社 <br />
                        <font class="book_publish">出版时间：2009年10月</font><br />
                        定价：￥28.00<br />
                        当当价：￥19.30 </dd>
                    <dt><img src="/statics/images/dd_culture_3.jpg" alt="history"/></dt>
                    <dd><font class="book_title">爷爷奶奶的“孙子兵法”</font><br />
                        作者：伏建全 编著 <br />
                        出版社：地震出版社 <br />
                        <font class="book_publish"> 出版时间：2009年8月</font><br />
                        定价：￥28.00<br />
                        当当价：￥17.40 </dd>
                    <dt><img src="/statics/images/dd_culture_4.jpg" alt="history"/></dt>
                    <dd><font class="book_title">1分钟读懂孩子心理</font><br />
                        作者：海韵　著 <br />
                        出版社：朝华出版社 <br />
                        <font class="book_publish">出版时间：2009年10月</font><br />
                ...
                <dl id="book_novel" class="book_none">
                    <dt><img src="/statics/images/dd_novel_1.jpg" alt="history"/></dt>
                    <dd><font class="book_title">嘿，我知道你</font><br />
                        作者：兰海　著 <br />
                        出版社：中国妇女出版社 <br />
                        <font class="book_publish">出版时间：2009年10月</font><br />
                        定价：￥28.80<br />
                        当当价：￥17.90 </dd>
                    <dt><img src="/statics/images/dd_novel_2.jpg" alt="history"/></dt>
                    <dd><font class="book_title">择业要趁早</font><br />
                        作者：（美）列文 <br />
                        出版社：海天出版社 <br />
                        <font class="book_publish">出版时间：2009年10月</font><br />
                        定价：￥28.00<br />
                        当当价：￥19.30 </dd>
                    <dt><img src="/statics/images/dd_novel_3.jpg" alt="history"/></dt>
                    <dd><font class="book_title">爷爷奶奶的“孙子兵法”</font><br />
                        作者：伏建全 编著 <br />
                        出版社：地震出版社 <br />
                        <font class="book_publish"> 出版时间：2009年8月</font><br />
                        定价：￥28.00<br />
                        当当价：￥17.40 </dd>
                    <dt><img src="/statics/images/dd_novel_4.jpg" alt="history"/></dt>
                    <dd><font class="book_title">1分钟读懂孩子心理</font><br />
                        作者：海韵　著 <br />
                        出版社：朝华出版社 <br />
                        <font class="book_publish">出版时间：2009年10月</font><br />
        ...
        <div class="book_sort">
            ...
            <div class="book_class" style="height:380px;">
                <dl id="book_focus">
                    <dt><img src="/statics/images/dd_focus_1.jpg" alt="focus"/></dt>
                    <dt><img src="/statics/images/dd_focus_2.jpg" alt="focus"/></dt>
                    <dt><img src="/statics/images/dd_focus_3.jpg" alt="focus"/></dt>
                    <dt><img src="/statics/images/dd_focus_4.jpg" alt="focus"/></dt>
                    ...
                    <dd>定价：￥29.00<br />
                        当当价：￥19.40</dd>
                    <dt><img src="/statics/images/dd_focus_5.jpg" alt="focus"/></dt>
                    <dt><img src="/statics/images/dd_focus_6.jpg" alt="focus"/></dt>
                    <dt><img src="/statics/images/dd_focus_7.jpg" alt="focus"/></dt>
                    <dt><img src="/statics/images/dd_focus_8.jpg" alt="focus"/></dt>
    ...
    <div id="silder">
        <!--书讯快递-->
        <div class="book_sort">
            <div class="book_sort_bg"><img src="/statics/images/dd_book_mess.gif" alt="mess" style=" vertical-align:text-bottom;"/>书讯快递</div>
            ...
            <div class="book_express_avder"> <img src="/statics/images/dd_book_right_adver1.jpg" alt="adver" style="margin-bottom:5px;" /> <img src="/statics/images/dd_book_right_adver2.gif" alt="adver" /> </div>
        </div>
        <!--近7日畅销榜-->
        <div class="book_sort">
            <div class="book_seven_title">近7日畅销榜 <img src="/statics/images/dd_bang.gif" alt="bang" style="vertical-align:top;"/></div>
                ...
                <div class="book_seven_content">
                    <div class="book_seven_content_left">
                        <dl id="book_seven_number">
                            <dt><img src="/statics/images/dd_book_no_01.gif" alt="book"/></dt>
                            <dt><img src="/statics/images/dd_book_no_02.gif" alt="book"/></dt>
                            <dt><img src="/statics/images/dd_book_no_03.gif" alt="book"/></dt>
                            <dd><img src="/statics/images/dd_book_no_04.gif" alt="book"/></dd>
                            <dd><img src="/statics/images/dd_book_no_05.gif" alt="book"/></dd>
                            <dd><img src="/statics/images/dd_book_no_06.gif" alt="book"/></dd>
                            <dd><img src="/statics/images/dd_book_no_07.gif" alt="book"/></dd>
                            <dd><img src="/statics/images/dd_book_no_08.gif" alt="book"/></dd>
         ...
         <dd><img src="images/dd_book_no_10.gif" alt="book"/></dd>-->
                    ...
                    <div class="book_seven_content_right">
                        ...
                        <div id="book_seven_hearten">
                            <dl>
                                <dt><img src="/statics/images/dd_seven_hearten_01.jpg" alt="hearten" /></dt>
                                <dd><a href="#" class="blue">不抱怨的世界</a><br />
                                    作者：（美）鲍温<br />
                                    出版社：陕西师范<br />
                                    出版时间：2009年4月</dd>
                                <dt><img src="/statics/images/dd_seven_hearten_02.jpg" alt="hearten" /></dt>
                                <dd><a href="#" class="blue">遇见未知的自己</a><br />
                                    作者：张德芬 <br />
                                    出版社：华夏出版<br />
                                    出版时间：2008年1月</dd>
                                <dt><img src="/statics/images/dd_seven_hearten_03.jpg" alt="hearten" /></dt>
    ...
    <!--右侧部分结束-->
    <script type="text/javascript" src="/statics/js/book.js"></script>
</div>
<!--网站版权部分开始-->
<div id="footer">
