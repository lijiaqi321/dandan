...
<body>
<div id="header"><iframe src="/user/header.html" height="155px" width="960px" frameborder="0"></iframe></div>
<!--中间部分开始-->
<div id="main">
    <div class="dd_index_top_adver"><img src="/statics/images/dd_index_top_adver.jpg" alt="通栏广告图片" /></div>
    <div class="current_place">您现在的位置：<a href="/user/dologin.html">当当图书</a> >> 小说 >> 财经</div>
    <!--左侧菜单开始-->
    <div id="product_left">
        ...
        <div class="product_catList_end">
            <img src="/statics/images/product_01.gif" alt="shopping">
            <img src="/statics/images/product_02.gif" alt="shopping">
        </div>
    </div>
    <!--右侧内容开始-->
    <div id="product_storyList">
        <div id="product_storyList_top">
            <ul>
                <li>排序方式</li>
                <li><img src="/statics/images/dd_arrow_right.gif" alt="arrow"></li>
                ...
                <li><img src="/statics/images/product_icon_01.gif" alt="icon"></li>
                <li><img src="/statics/images/product_icon_02.gif" alt="icon"></li>
                <li><img src="/statics/images/product_icon_03.gif" alt="icon"></li>
                <li><img src="/statics/images/product_icon_04.gif" alt="icon"></li>
                <li>每页显示的数量</li>
                <li><img src="/statics/images/dd_arrow_right.gif" alt="arrow"></li>
                <li><img src="/statics/images/product_icon_20.gif" alt="icon"></li>
                <li><img src="/statics/images/product_icon_40.gif" alt="icon"></li>
                <li style="float:right; padding-right:10px;"><img src="/statics/images/product_page_down.gif" alt="icon"></li>
                <li style="float:right;">第1页</li>
                <li style="float:right;"><img src="/statics/images/product_page_up.gif" alt="icon"></li>
            </ul>
        </div>
        <!--图书排列开始-->
        <div class="product_storyList_content">
            ...
            <!--列表开始-->
            <div class="product_storyList_content_left"><img src="/statics/images/product_list_01.jpg" alt="图书列表"></div>
            <div class="product_storyList_content_right">
                <ul>
                    ...
                    <li>顾客评分：<img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_gray.gif" alt="star"></li>
                    ...
                    <li>
                        <dl class="product_content_dd">
                            <dd><img src="/statics/images/product_buy_02.gif" alt="shopping"></dd>
                            <dd><img src="/statics/images/product_buy_01.gif" alt="shopping"></dd>
                            <dd>节省：￥13.10</dd>
                            <dd>折扣：59折</dd>
            ...
            <!--列表开始-->
            <div class="product_storyList_content_left"><img src="/statics/images/product_list_02.jpg" alt="图书列表"></div>
            <div class="product_storyList_content_right">
                <ul>
                    <li class="product_storyList_content_dash"><a href="#" class="blue_14">圈子圈套.1.战局篇 </a></li>
                    <li>顾客评分：<img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red2.gif" alt="star"></li>
            ...
            <div class="product_storyList_content_bottom"></div>
            <!--列表开始-->
            <div class="product_storyList_content_left"><img src="/statics/images/product_list_03.jpg" alt="图书列表"></div>
            <div class="product_storyList_content_right">
                <ul>
                    <li class="product_storyList_content_dash"><a href="#" class="blue_14">饕餮（最真实的商场高端博弈小说）  </a></li>
                    <li>顾客评分：<img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red.gif" alt="star"><img src="/statics/images/star_red.gif" alt="star"></li>
            ...
            <div class="product_storyList_content_bottom"></div>
            <!--列表开始-->
            <div class="product_storyList_content_left"><img src="/statics/images/product_list_04.jpg" alt="图书列表"></div>
            <div class="product_storyList_content_right">
                <ul>
            ...
            <div class="product_storyList_content_bottom"></div>
            <!--列表开始-->
            <div class="product_storyList_content_left"><img src="/statics/images/product_list_05.jpg" alt="图书列表"></div>
            <div class="product_storyList_content_right">
                <ul>
            ...
            <div>
                <dl class="product_content_dd">
                    <dd><img src="/statics/images/OK.gif" alt="ok"></dd>
                    <dd>页</dd>
                    <dd><input name="page" type="text" value="1" style="width:20px;"></dd>
                    <dd>跳转到第</dd>
                    <dd><img src="/statics/images/next.gif" alt="ok"></dd>
                    ...
                    <dd><img src="/statics/images/product_page_up.gif" alt="ok"></dd>
                </dl>
            </div>
        </div>
    </div>
...
<div id="footer">
    ...
    <iframe src="/user/footer.html" height="50px" width="900px" frameborder="0"></iframe></div>
</body>
</html>
